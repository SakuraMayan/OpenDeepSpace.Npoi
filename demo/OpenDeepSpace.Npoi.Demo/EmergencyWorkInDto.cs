...
namespace OpenDeepSpace.Npoi.Demo
{
    public class EmergencyWorkerInDto
    {
        ...
        [ExcelColumn(ColOrder = 1, ColName = "姓名")]
        ...
        /// 电话
        /// </summary>
        [ColumnNotNull(ErrorMessage = "手机号码不能为空")]
        [ExcelColumn(ColOrder = 3, ColName = "手机号码")]
        ...
        [ExcelColumn(ColOrder = 2, ColName = "工号")]
        ...
        /// 备用电话
        /// </summary>
        [ExcelColumn(ColOrder = 4, ColName = "备用手机号码")]
